...
<template>
  <div class="container">
    ...
    <el-card class="box-card vip-card">
      <div>
        <el-avatar :src="picture" :size="100" :fit="fit" />
        <div class="VIPInfo">
          <p class="userId">
            <span> VIP账号: {{ vipInfo.vip_user_account }}</span>
            <i class="icon">年卡会员</i>
          </p>
          <p>
            {{ vipInfo.expiration_time }} 过期<el-button type="warning" round>立即续费</el-button>
          </p>
...
.vip-card {
  background: linear-gradient(to bottom right, rgb(229, 193, 107), rgb(195, 151, 76));
  padding-left: 5%;
  padding-right: 10%;
  height: 300px;
  border-radius: 30px;
